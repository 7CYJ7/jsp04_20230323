...
<body>
	<%
		...
		String m_choice = request.getParameter("choice"); // 통신사(셀렉트_옵션)
		String m_ph01 = request.getParameter("phone1"); // 전화번호 앞자리
		String m_ph02 = request.getParameter("phone2"); // 전화번호 가운데자리
		...
		String[] m_hobby = request.getParameterValues("hobby"); // 취미(배열) 0개~4개를 가져올수있다.
